...
score: 7.0
evidence: 面向具身智能体的视觉-语言-动作模型的强化学习价值估计框架
tldr: 针对具身强化学习在视觉-语言-动作（VLA）模型上因稀疏监督和奖励设计困难而受限的问题，提出Feat2Go，利用预训练视觉世界模型推导连续进度目标，通过补丁级相似度度量子目标，并基于趋势聚类划分语义阶段，训练细粒度价值模型，有效提升VLA模型在复杂操作任务中的RL性能。
source: arxiv
...
motivation: 面向具身智能体的视觉-语言-动作模型的强化学习价值估计框架。
