...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-17 20:11:36 UTC<br>状态：成功</p>
</section>
...
<p>精读：《SHE: Trajectory-driven Safety Harness Evolution for LLM Agents》（8.0/10）, 《TideRL: Boosting Agentic RL Goodput with Readiness-Aware Scheduling》（8.0/10）</p>
<p>速读：《Capability Sheaves for Compositional Agent-Harness Repair: Controlled Quotients and a Real-Repository Stress Test》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SHE: Trajectory-driven Safety Harness Evolution for LLM Agents">SHE: Trajectory-driven Safety Harness Evolution for LLM Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="TideRL: Boosting Agentic RL Goodput with Readiness-Aware Scheduling">TideRL: Boosting Agentic RL Goodput with Readiness-Aware Scheduling</span></li><li><span class="dpr-home-dashboard-paper-title" title="Scheduling Mixed RL Rollouts Beyond Prefix Locality">Scheduling Mixed RL Rollouts Beyond Prefix Locality</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">self-improve <strong>4</strong></span><span class="dpr-home-dashboard-tag">agentic-rl <strong>3</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Capability Sheaves for Compositional Agent-Harness Repair: Controlled Quotients and a Real-Repository Stress Test">Capability Sheaves for Compositional Agent-Harness Repair: Controlled Quotients and a Real-Repository Stress Test</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">self-improve <strong>1</strong></span></div>
</section>
</div>
